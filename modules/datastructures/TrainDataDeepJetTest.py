...
class TrainDataDeepJetTest(TrainData):
    '''
    ...
    def __init__(self):
        ...
        self.registerBranches(['Jet_uncorrpt','Jet_eta'])
        
        self.weightbranchX='Jet_uncorrpt'
...
class TrainData_Flavours(TrainDataDeepJetTest):
    '''
    
    '''
    def __init__(self):
        TrainDataDeepJetTest.__init__(self)
        self.clear()
...
class TrainData_simplerTruth(TrainDataDeepJetTest):
    def __init__(self):
        TrainDataDeepJetTest.__init__(self)
        self.clear()
