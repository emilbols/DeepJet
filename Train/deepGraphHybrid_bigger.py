...
if newtraining:
    from models import model_deepFlavourReference_GraphHybrid_bigger
    
    train.setModel(model_deepFlavourReference_GraphHybrid_bigger,dropoutRate=0.1,momentum=0.3)
