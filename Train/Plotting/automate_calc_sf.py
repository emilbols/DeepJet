...
f = ROOT.TFile("automated_SF_"+tagger+"_30GeV.root", "recreate")       
f.Write()
sf_eff, sf_mis, eff, mis, effective_sf = lal(truth,pred,"automated_SF_"+tagger+"_"+str(pt_cut)+"GeV.root","roccurve_0",True,pt_cut,SF_file,tagger)
