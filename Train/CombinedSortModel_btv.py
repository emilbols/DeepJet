...
if newtraining:
    from models import model_deepFlavourReference_fat_comb_smooth_v4
    
    train.setModel(model_deepFlavourReference_fat_comb_smooth_v4,dropoutRate=0.1,momentum=0.3)
