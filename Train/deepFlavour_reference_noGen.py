...
if newtraining:
    ...
    #train.train_data.maxFilesOpen=20
    
    print(train.keras_model.summary())
    model,history = train.trainModel_noGen(nepochs=1, 
                                           batchsize=10000, 
                                           stop_patience=300, 
                                           lr_factor=0.5, 
                                           lr_patience=3, 
...
model,history = train.trainModel_noGen(nepochs=30, #sweet spot from looking at the testing plots 
                                       batchsize=10000, 
                                       stop_patience=300, 
                                       lr_factor=0.8, 
                                       lr_patience=15, 
