...
if newtraining:
    from models import model_deepFlavourReference_newAttempt
    
    train.setModel(model_deepFlavourReference_newAttempt,dropoutRate=0.1,momentum=0.3)
...
model,history = train.trainModel(nepochs=63, #sweet spot from looking at the testing plots 
                                 ...
                                 lr_cooldown=8, 
                                 lr_minimum=0.00001, 
                                 maxqsize=2,verbose=1,checkperiod=3)
